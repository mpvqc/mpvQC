            ...
            mpvqcApplication: QtObject {
                ...
                property var mpvqcUtilityPyObject: QtObject {
                    function copyToClipboard(text) {
                        __objectUnderTest.clipboardText = text;
                    }
                ...
                property var mpvqcCommentTable: __objectUnderTest
        ...
        return [
            {
                ...
                columnClicked: columnPlayButton,
                rowClicked: row1,
                rowIndexExpected: 0
            },
            {
                tag: "on-same-row-time-label-clicked",
                columnClicked: columnTime,
                rowClicked: row1,
                rowIndexExpected: 0
            },
            {
                tag: "on-same-row-comment-type-label-clicked",
                columnClicked: columnCommentType,
                rowClicked: row1,
                rowIndexExpected: 0
            },
            {
