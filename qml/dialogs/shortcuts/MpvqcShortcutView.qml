...
ColumnLayout {
    ...
    TextField {
        ...
        onTextChanged: {
            console.log("Search", _textField.text)
        }
    ...
    ListView {
        ...
        readonly property int scrollBarSpace: _scrollBar.visibleWidth + spaceBetweenItemAndScrollbar
        ...
        delegate: MpvqcShortcut {
            ...
            isAndConnection: model.isAndConnection ?? true
