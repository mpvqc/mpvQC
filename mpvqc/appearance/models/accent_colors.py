...
from mpvqc.appearance.services import Dark, FollowSystem, Light, PaletteCatalogService
...
if TYPE_CHECKING:
    ...
    from mpvqc.appearance.services import ColorSchemePreference, Palette
