...
from .footer import MpvqcFooterViewModel as MpvqcFooterViewModel
...
from .new_comment_menu import MpvqcNewCommentMenuViewModel as MpvqcNewCommentMenuViewModel
