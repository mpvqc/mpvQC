...
class MpvqcAccentColorModel(QAbstractListModel):
    ...
    def __init__(self, parent: QObject | None = None) -> None:
        ...
        self._color_scheme: EffectiveColorScheme | None = None

    def set_color_scheme(self, color_scheme: EffectiveColorScheme | None) -> None:
        if color_scheme is self._color_scheme:
            return
    ...
    def _palette_count_of(self, color_scheme: EffectiveColorScheme | None) -> int:
