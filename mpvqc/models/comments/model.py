...
from mpvqc.services import ImportExportWiringService, PlayerService, StateService, TimeFormatterService
...
class MpvqcCommentModel(QStandardItemModel):
    ...
    def __init__(self):
        ...
        self._import_export.comments_ready_for_import.connect(self.import_comments)
