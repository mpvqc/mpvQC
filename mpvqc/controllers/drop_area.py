...
from mpvqc.services import ImportExportWiringService, MimetypeProviderService, TypeMapperService
...
class ImportJob(QRunnable):
    _import_export_service: ImportExportWiringService = inject.attr(ImportExportWiringService)
    ...
    def run(self):
        subtitle_extensions = self._mimetype_provider.subtitle_file_extensions
        ...
        self._import_export_service.open(documents, videos, subtitles)
