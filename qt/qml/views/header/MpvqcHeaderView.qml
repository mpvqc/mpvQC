...
Item {
    ...
    required property MpvqcToolBarViewModel toolBarViewModel
    ...
    readonly property int leftContentWidth: menuBarWidth + minTitleSpacing + _toolBar.width
    ...
    RowLayout {
        ...
        Item {
            Layout.preferredWidth: root.minTitleSpacing
        ...
        MpvqcToolBarView {
            ...
            viewModel: root.toolBarViewModel
            buttonHeight: root.menuBarHeight
            largeSpacing: root.minTitleSpacing
        }
