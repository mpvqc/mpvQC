...
TestCase {
    ...
    function test_newQcDocumentWhenUnsaved(data): void {
        ...
        tryVerify(() => findChild(control, "resetMessageBox"));
        const messageBox = findChild(control, "resetMessageBox");
    ...
    function test_openQcDocument(data): void {
        ...
        const dialog = it.findVisibleDialog(control, "importDocumentsFileDialog");
    ...
    function test_saveQcDocument_promptsThenSavesDirectly(): void {
        ...
        const dialog = it.findVisibleDialog(control, "saveDocumentFileDialog");
    ...
    function test_saveQcDocumentAs_alwaysPromptsForPath(): void {
        ...
        const firstDialog = it.findVisibleDialog(control, "saveDocumentFileDialog");
        ...
        const secondDialog = it.findVisibleDialog(control, "saveDocumentFileDialog");
    ...
    function test_extendedExport_writesFileUsingTemplate(): void {
        ...
        const dialog = it.findVisibleDialog(control, "exportDocumentFileDialog");
        const savePath = it.bridge.tempSavePath();
        dialog.selectedFile = savePath;
        it.acceptDialog(dialog);
    ...
    function test_extendedExport_brokenTemplate_opensErrorMessageBox(): void {
        ...
        const timeout = 5000;
        tryVerify(() => findChild(control, "extendedExportErrorMessageBox"), timeout, "error message box should open");
    }
}
