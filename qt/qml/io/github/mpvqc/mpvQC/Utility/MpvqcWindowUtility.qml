...
QtObject {
    ...
    property var _viewModel: MpvqcWindowControlsViewModel {}
    ...
    readonly property bool drawsOwnFrame: _viewModel.drawsOwnFrame
    readonly property int windowRadius: drawsOwnFrame ? 8 : 0
