...
ListView {
    ...
    highlight: Item {
        Rectangle {
            ...
            color: root.mpvqcAppearance.palette.rowSelected
    ...
    delegate: ItemDelegate {
        ...
        readonly property color foregroundColor: root.mpvqcAppearance.palette.foreground
        readonly property color stripeColor: root.mpvqcAppearance.listStripe
        readonly property color backgroundColor: ListView.isCurrentItem ? (root._moving ? root.mpvqcAppearance.palette.rowSelected : "transparent") : index % 2 === 1 ? stripeColor : "transparent"
        ...
        M.Material.foreground: ListView.isCurrentItem ? root.mpvqcAppearance.palette.rowSelectedText : foregroundColor
