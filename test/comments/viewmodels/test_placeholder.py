...
def configure_inject(common_bindings_with, settings_service):
...
def test_mirrors_settings_and_forwards_a_change(settings_service, make_spy):
    settings_service.layout_orientation = Qt.Orientation.Vertical.value
    ...
    settings_service.layout_orientation = Qt.Orientation.Horizontal.value
