...
class Scenario(NamedTuple):
    ...
    found_video_setting: LoadFoundVideo = LoadFoundVideo.ASK_EVERY_TIME
...
SIMPLE_DOCUMENT_IMPORTS = [
    Scenario(
        ...
        found_video_setting=LoadFoundVideo.ALWAYS,
...
EXPLICIT_RESOURCE_IMPORTS = [
    ...
    Scenario(
        ...
        expected=UnfinishedPlan(
            comments=(),
            session=SessionMerge(),
            video=VideoUnresolved(candidates=(VID_A_EXPLICIT, VID_B_EXPLICIT)),
            subtitles=SubtitlesSkip(),
            errors=ErrorsAbsent(),
        ),
    ),
...
ERROR_IMPORTS = [
    ...
    Scenario(
        ...
        expected=UnfinishedPlan(
            comments=stub_comments(5),
            session=SessionUnresolved(incoming_comment_count=5),
            video=VideoUnresolved(candidates=(VID_A_DOC, VID_B_DOC)),
            subtitles=SubtitlesUnresolved(candidates=(SUB_A,)),
            errors=ErrorsPresent(rejected_documents=(REJECTED_BROKEN,)),
        ),
    ),
...
MIXED_PROVENANCE = [
    ...
    Scenario(
        ...
        expected=UnfinishedPlan(
            comments=(),
            session=SessionMerge(),
            video=VideoUnresolved(candidates=(VID_A_SUB,)),
            subtitles=SubtitlesUnresolved(candidates=(SUB_A,)),
            errors=ErrorsAbsent(),
        ),
    ),
    ...
    Scenario(
        ...
        expected=UnfinishedPlan(
            comments=(),
            session=SessionMerge(),
            video=VideoUnresolved(candidates=(VID_A_SUB, VID_B_SUB)),
            subtitles=SubtitlesUnresolved(candidates=(SUB_A, SUB_B)),
            errors=ErrorsAbsent(),
        ),
    ),
    ...
    Scenario(
        name="explicit sub + doc-derived sub, video step fires, doc sub still dropped",
