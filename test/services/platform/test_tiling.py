...
@pytest.mark.parametrize(
    ...
    [
        ...
        TilingDesktopTestCase("semicolon separated", "sway;wlroots", expected=True),
        TilingDesktopTestCase("trailing separator", "sway;", expected=True),
        TilingDesktopTestCase("padded name", "GNOME: i3 ", expected=True),
        TilingDesktopTestCase("mixed case", "Hyprland", expected=True),
        TilingDesktopTestCase("compositor beside its display server", "miracle-wm;mir", expected=True),
        TilingDesktopTestCase("display server alone", "mir", expected=False),
        TilingDesktopTestCase("renamed compositor", "mangowc", expected=False),
        TilingDesktopTestCase("non tiling desktop", "GNOME", expected=False),
        TilingDesktopTestCase("empty", "", expected=False),
