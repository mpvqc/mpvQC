// PROTOTYPE - Variant A "Overview": the whole import plan on one page, appearance-dialog style.
// No steps at all. Every concern is a section card; resolved concerns read as facts, open
// concerns carry their picker inline. One "Confirm import" for everything.
